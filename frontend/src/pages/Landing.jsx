...
export default function Landing({ onStart, onQuickDemo }) {
  const workflowSteps = [
    ...
    { num: '06', title: 'UNDERSTAND', desc: 'Personalized preventive guidance' },
    { num: '07', title: 'TRACK', desc: 'Longitudinal monitoring over time' },
    ...
    <div className="landing-page">
      ...
      <section className="hero-section">
        <div className="hero-badge">
          ...
          <span>Preventive Oral Health Screening & Longitudinal Monitoring</span>
        </div>
        ...
        <p className="hero-subtitle">
          ...
          and deterministic scoring. Track changes over time, generate a dentist-ready summary, and connect
